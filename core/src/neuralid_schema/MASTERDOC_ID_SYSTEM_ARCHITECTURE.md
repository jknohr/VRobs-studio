...
└── [s-prefix]/                           # Species directory (1 char)
    ...
    └── [s-prefix][e-prefix]/            # Ethnicity directory (3 chars total)
        ...
        │
        └── [s-prefix][e-prefix][l-prefix]/             # Origin directory (5 chars total = SymbioticPrefix)
            ├── [s-prefix][e-prefix][l-prefix]-00000000000000000000000000.fbs  # Instance schema
            ├── [s-prefix][e-prefix][l-prefix]_VectorDoll-00000000000000000000000000.fbs                  # UI injection
            ├── [s-prefix][e-prefix][l-prefix]_DecayRule-00000000000000000000000000.fbs                   # Lifecycle
            └── [s-prefix][e-prefix][l-prefix]_BrainJob-00000000000000000000000000.fbs                    # AI logic
...
Name of Prefix for that level                |   s-prefix      |   e-prefix        |    l-prefix         |   x   |
-----------------------------------------------------------------------------------------------------------------
...
table NeuralIdIndex {
    ...
    /// Origin prefix (2 chars: AC) - l-prefix
    origin: string;
...
└── [s-prefix]/                           # Species directory (1 char: N, F, A, etc.)
    ...
    └── [s-prefix][e-prefix]/             # Ethnicity directory (3 chars: NAU, NVI, etc.)
        ...
        │
        └── [s-prefix][e-prefix][l-prefix]/                          # Origin directory (5 chars: NAUAC, etc.)
            ├── [s-prefix][e-prefix][l-prefix]-index.fbs             # ← Index of instances with THIS prefix
            ├── [s-prefix][e-prefix][l-prefix]-00000000000000000000000000.fbs      # Default template
            ├── [s-prefix][e-prefix][l-prefix]_VectorDoll-00000000000000000000000000.fbs
            ├── [s-prefix][e-prefix][l-prefix]_DecayRule-00000000000000000000000000.fbs
            └── [s-prefix][e-prefix][l-prefix]_BrainJob-00000000000000000000000000.fbs
```
...
table N_Index {
    ...
    /// Lineage pedigree (array of l-prefixes)
...
**Location**: `schemas/[s-prefix]/[s-prefix][e-prefix]/[s-prefix][e-prefix][l-prefix]/[s-prefix][e-prefix][l-prefix]-index.fbs`  
...
**Location**: `schemas/[s-prefix]/[s-prefix][e-prefix]/[s-prefix][e-prefix][l-prefix]/[s-prefix][e-prefix][l-prefix]-00000000000000000000000000.fbs`  
...
**Location**: `schemas/[s-prefix]/[s-prefix][e-prefix]/[s-prefix][e-prefix][l-prefix]/[s-prefix][e-prefix][l-prefix]_VectorDoll-00000000000000000000000000.fbs`  
...
**Location**: `schemas/[s-prefix]/[s-prefix][e-prefix]/[s-prefix][e-prefix][l-prefix]/[s-prefix][e-prefix][l-prefix]_DecayRule-00000000000000000000000000.fbs`  
...
**Location**: `schemas/[s-prefix]/[s-prefix][e-prefix]/[s-prefix][e-prefix][l-prefix]/[s-prefix][e-prefix][l-prefix]_BrainJob-00000000000000000000000000.fbs`  
